...
public class Regex {
    ...
    public void testCO () {
        String coOr1 = "(\\d{2}-((00[1-9])|(0[1-9][0-9])|([1-2][0-9][0-9])|(3[0-5][0-9])|(36[0-6]))-\\d{4})";
        String coOr2 = "(\\d{2}((00[1-9])|(0[1-9][0-9])|([1-2][0-9][0-9])|(3[0-5][0-9])|(36[0-6]))\\d{4})";
        String coOr3 = "([a-zA-Z]\\d{6})";

        String coOne = "(?:\\d{2}({co_delim}[ -]?)(?:(?:00[1-9])|(?:0[1-9][0-9])|(?:[1-2][0-9][0-9])|(?:3[0-5][0-9])|(?:36[0-6])){\\co_delim}\\d{4})";
    }
